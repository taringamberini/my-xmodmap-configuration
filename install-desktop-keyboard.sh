...
echo "Installing xmodmap desktop configuration in ~/$INSTALL_DIR"
...
ln -s ~/$INSTALL_DIR/xmodmaprc-desktop-keyboard ~/.xmodmaprc
echo "success"

echo "xmodmap desktop installation completed :-)"
